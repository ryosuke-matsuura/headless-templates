...
export function Shop({ items }: { items: products.Product[] }) {
  return (
    <div className="mx-auto">
      ...
      <h2 className="text-center pt-20" style={{ fontFamily: '"Noto Serif JP"' }}>Line up</h2><div className=" text-custom-1 text-center py-8 sm:py-8 h-[150px] sm:h-[150px]" data-testid={testIds.SHOP_PAGE.HEADER}>
      </div>
      {items.length ? (
